...
# sys.path.append('/home/train/VLA-probing/openpi/third_party/libero_original/libero')
...
def save_rollout_video(replay_images, path, task_description):
    """Saves a video replay of a rollout in libero."""
    os.makedirs(os.path.dirname(path), exist_ok=True)
    processed_task_description = task_description.lower().replace(" ", "_").replace("\n", "_").replace(".", "_")[:50]
    video_path = f"{path}/--task={processed_task_description}.mp4"
